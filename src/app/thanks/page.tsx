      ...
      <main className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            <Link href="/" className="text-blue-600 hover:text-blue-800 flex items-center gap-2 mb-6 justify-center">
          ...
          <div className="bg-white rounded-lg shadow-md p-8 mb-8">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h2 className="text-2xl font-semibold text-gray-900">OpenHands AI Team</h2>
                <p className="text-gray-600">The brilliant minds behind autonomous AI development</p>
              </div>
            </div>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li className="flex items-center gap-2">
                    ...
                    <span className="text-gray-600">Next.js 16 - React Framework</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="w-2 h-2 bg-blue-500 rounded-full"></span>
                    <span className="text-gray-600">React 19 - UI Library</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="w-2 h-2 bg-blue-500 rounded-full"></span>
                  ...
                  <li className="flex items-center gap-2">
                    <span className="w-2 h-2 bg-blue-500 rounded-full"></span>
                    <span className="text-gray-600">Tailwind CSS 4 - Styling</span>
                  </li>
                </ul>
              </div>
              <div>
                <h3 className="text-lg font-medium text-gray-900 mb-3">Development & Deployment</h3>
                <ul className="space-y-2">
                  <li className="flex items-center gap-2">
                    <span className="w-2 h-2 bg-green-500 rounded-full"></span>
                    <span className="text-gray-600">GitHub Pages - Hosting</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="w-2 h-2 bg-green-500 rounded-full"></span>
                    <span className="text-gray-600">GitHub Actions - CI/CD</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="w-2 h-2 bg-green-500 rounded-full"></span>
                    <span className="text-gray-600">ESLint - Code Quality</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="w-2 h-2 bg-green-500 rounded-full"></span>
                    <span className="text-gray-600">Git - Version Control</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-8 mb-8">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h2 className="text-2xl font-semibold text-gray-900">Open Source Community</h2>
                <p className="text-gray-600">The foundation that makes everything possible</p>
              </div>
            </div>
            <div className="grid md:grid-cols-3 gap-4">
              <div className="text-center p-4 bg-gray-50 rounded-lg">
                <h4 className="font-medium text-gray-900 mb-2">React Team</h4>
                <p className="text-sm text-gray-600">For creating the revolutionary UI library</p>
              </div>
              <div className="text-center p-4 bg-gray-50 rounded-lg">
                <h4 className="font-medium text-gray-900 mb-2">Vercel Team</h4>
                <p className="text-sm text-gray-600">For Next.js and modern web development tools</p>
              </div>
              <div className="text-center p-4 bg-gray-50 rounded-lg">
                <h4 className="font-medium text-gray-900 mb-2">Tailwind Labs</h4>
                <p className="text-sm text-gray-600">For the utility-first CSS framework</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-8 mb-8">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h2 className="text-2xl font-semibold text-gray-900">AI Research Community</h2>
                <p className="text-gray-600">Advancing the frontiers of artificial intelligence</p>
              </div>
            </div>
            <p className="text-gray-600 mb-4">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                <h4 className="font-medium text-gray-900 mb-2">Research Foundations</h4>
              ...
              <div>
                <h4 className="font-medium text-gray-900 mb-2">Open Source AI Tools</h4>
                <ul className="text-sm text-gray-600 space-y-1">
          ...
          <div className="bg-white rounded-lg shadow-md p-8 mb-8">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h2 className="text-2xl font-semibold text-gray-900">GitHub & Microsoft</h2>
                <p className="text-gray-600">Providing the platform for collaboration and hosting</p>
              </div>
            </div>
            <p className="text-gray-600 mb-4">
          ...
          {/* Project Stats */}
          <div className="bg-white rounded-lg shadow-md p-8 mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-6">Project Statistics</h2>
            <div className="grid md:grid-cols-4 gap-6 text-center">
              ...
              <div className="p-4 bg-green-50 rounded-lg">
                ...
                <div className="text-sm text-gray-600">Human Code Lines</div>
              </div>
