      ...
      <main className="container mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="bg-white p-6 rounded-lg shadow-md border border-green-100">
            ...
            <h3 className="text-xl font-semibold mb-2 text-green-800">AI-Generated Code</h3>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border border-green-100">
            ...
            <h3 className="text-xl font-semibold mb-2 text-green-800">Automated Workflow</h3>
            <p className="text-green-700">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border border-green-100">
            ...
            <h3 className="text-xl font-semibold mb-2 text-green-800">Open Source</h3>
            <p className="text-green-700">
